<div>
    ...
    <div class="card card-default">
        <div class="card-body">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    @forelse ($targets as $key=>$target)
                        ...
                        <td>{{ $target->VisitsTarget ?? 0 }}</td>
                        <td>{{ $target->AchievedVisitsTarget ?? 0 }}</td>
                        <td>{{ $target->Deadline ?? '' }}</td>
                        <td>
                            {{ $this->getSuccessRatio($target->AchievedVisitsTarget ?? 0, $target->VisitsTarget ?? 0) }}%
                        </td>
                            <td>
                                <div class="dropdown">
            ...
            <div class="mt-1"> {{ $targets->links() }}</div>
