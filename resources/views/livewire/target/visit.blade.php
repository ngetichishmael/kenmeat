                ...
                <tbody>
                    @forelse ($targets as $key=>$target)
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{ $target->name }}</td>
                            <td>{{ $target->TargetVisit->VisitsTarget ?? 0 }}</td>
                            <td>{{ $target->TargetVisit->AchievedVisitsTarget ?? 0 }}</td>
                            <td>{{ $target->TargetVisit->Deadline ?? '' }}</td>
                            <td>
                                {{ $this->getSuccessRatio($target->TargetVisit->AchievedVisitsTarget ?? 0, $target->TargetVisit->VisitsTarget ?? 0) }}%
                            </td>
                            <td>
                                <div class="dropdown">
