                    ...
                    <div class="card-body invoice-padding pb-0">
                        ...
                        <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                            <div>
                                ...
                                <p class="card-text mb-25">Main Office, KenBeauty</p>
                                <p class="card-text mb-25">Nairobi Kenya</p>
                                <p class="card-text mb-0">+254 (123) 456 7891 </p>
                                <p class="card-text mb-0"> <b> Order Status </b> : <span
                                        class="badge badge-pill badge-light-success mr-1"> {{ $order->order_status ?? '' }}
                                    </span> </p>
                            </div>
